...
class TrelloClient:
    ...
    def get_board_lists(self, board_id: str) -> list[dict[str, Any]]:
        return self._request("GET", f"/boards/{board_id}/lists", params={"fields": "name"})
    ...
    def get_card(self, card_id: str, *, fields: str) -> dict[str, Any]:
        return self._request("GET", f"/cards/{card_id}", params={"fields": fields, "members": "true", "member_fields": "username,fullName"})

    def create_card(self, *, name: str, desc: str, list_id: str, member_ids: Optional[Iterable[str]] = None, label_ids: Optional[Iterable[str]] = None) -> dict[str, Any]:
    ...
    def list_card_actions(self, card_id: str, *, limit: int = 50, filter: str = "commentCard") -> list[dict[str, Any]]:
        return self._request("GET", f"/cards/{card_id}/actions", params={"limit": limit, "filter": filter, "memberCreator_fields": "fullName,username"})
